...
def get_args():
    ...
    parser.add_argument('--data_dir', type=str, default='/apdcephfs/share_1290939/jiaxiaojun/cifar-data100')
    parser.add_argument('--norm', type=str, default='Linf')
    parser.add_argument('--epsilon', type=int, default=8)
    parser.add_argument('--model_path', type=str, default='/apdcephfs/private_xiaojunjia/LAS-AT/weights/LAS-AT/CIFAR100/LAS_Trades/model.pth')
