...
class ResNet_StrategyNet(nn.Module):
    def __init__(self, block, num_blocks,  args):
        self.args = args
        super(ResNet_StrategyNet, self).__init__()
        self.in_planes = 64
...
def ResNet18_StrategyNet(args):
    return ResNet_StrategyNet(BasicBlock, [2, 2, 2, 2],args)


def ResNet34_StrategyNet(args):
    return ResNet_StrategyNet(BasicBlock, [3, 4, 6, 3],args)


def ResNet50_StrategyNet(args):
    return ResNet_StrategyNet(Bottleneck, [3, 4, 6, 3],args)


def ResNet101_StrategyNet(args):
    return ResNet_StrategyNet(Bottleneck, [3, 4, 23, 3],args)


def ResNet152_StrategyNet(args):
    return ResNet_StrategyNet(Bottleneck, [3, 8, 36, 3],args)
