...
def get_args():
    ...
    parser.add_argument('--data-dir', default='../tiny-imagenet-200', type=str)
    ...
    parser.add_argument('--epsilon_types', type=int, nargs="*", default=range(5, 10))
    parser.add_argument('--attack_iters_types', type=int, nargs="*", default=range(7, 14))
...
def train(epoch):
    ...
    for batch_idx, (inputs, targets) in enumerate(train_loader):
        ...
        torch.nn.utils.clip_grad_norm_(target_model.parameters(),10.0)
